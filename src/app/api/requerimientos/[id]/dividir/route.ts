...
// body: { partes: number[] }  ej: [1, 1] o [1, 3] o [2, 2]
//   - Deben sumar como máximo la cantidad original
//   - Si suma menos, el remanente queda como un nuevo registro
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    const result = await prisma.$transaction(async (tx: any) => {
      ...
      // Si la suma de partes es MENOR que la cantidad original, crear un registro con el remanente
